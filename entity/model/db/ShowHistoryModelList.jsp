<% HistoryModelList theObjectList = (HistoryModelList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% HistoryModel theObject = (HistoryModel) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
