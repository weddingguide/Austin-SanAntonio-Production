<% PhoneModelList theObjectList = (PhoneModelList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% PhoneModel theObject = (PhoneModel) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
