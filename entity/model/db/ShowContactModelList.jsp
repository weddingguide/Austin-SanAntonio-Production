<% ContactModelList theObjectList = (ContactModelList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% ContactModel theObject = (ContactModel) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
