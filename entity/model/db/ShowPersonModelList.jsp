<% PersonModelList theObjectList = (PersonModelList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% PersonModel theObject = (PersonModel) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
