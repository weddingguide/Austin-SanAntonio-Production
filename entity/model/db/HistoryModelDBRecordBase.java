...
public class HistoryModelDBRecordBase extends ServletRecord
{
   ...
   public HistoryModelDBRecordBase( DBData aDbData, ResultSet results )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( results );
//    log.logEvent( log.TRACE, "HistoryModelDBRecordBase constructor from ResultSet");
   }
   ...
   public HistoryModelDBRecordBase( DBData aDbData, HttpServletRequest request, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( request, label );
//    log.logEvent( log.TRACE, "HistoryModelDBRecordBase constructor from label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public HistoryModelDBRecordBase( DBData aDbData, Hashtable hashTable, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( hashTable, label );
//    log.logEvent( log.TRACE, "HistoryModelDBRecordBase constructor from hashTable - label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public HistoryModelDBRecordBase( DBData aDbData, HttpServletRequest request, String label, int aId )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      id = aId;
      populateObject( request, label );
//    log.logEvent( log.TRACE, "HistoryModelDBRecordBase constructor from label: " + label + " & id: " + id );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public HistoryModelDBRecordBase( DBData dbData )
   {
      super( dbData );
      createColumnObjects( dbData );
//    log.logEvent( log.TRACE, "HistoryModelDBRecordBase basic constructor");
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public HistoryModelDBRecordBase( DBData dbData, String[] fields, int[] map )
   {
      super( dbData );
      createColumnObjects( dbData );
      log.logEvent( log.TRACE, "HistoryModelDBRecordBase constructor from array");
   ...
   protected void createColumnObjects( DBData aDbData )
   {
      ...
      dbColumns[0] = new ServletStringColumn( aDbData, "HISTORYMODEL.NAME", "HISTORYMODEL", "name" );
   ...
   {
      String retString = "\n" + prefix + "HistoryModel Object:";
      try 
      {
         refreshColumnObjects();
         retString += "\n"+ prefix +   "    name (HISTORYMODEL.NAME) -- ";
   ...
   public String toCSVHeaderString(HistoryModelViewBase viewDef, int ndx )
   {
      String retString = "";
   ...
   public String toCSVString(HistoryModelViewBase viewDef )
   {
      String retString = "";
      try 
      {
   ...
   {
      sysLogger.info( "DROP TABLE HISTORYMODEL;" );
      sysLogger.info( "CREATE TABLE HISTORYMODEL ( HISTORYMODEL.NAME char );" );
   }
   public String exportSQLInsertStatement()
   {
      refreshColumnObjects();
      String retString = "HistoryModel Object:";
