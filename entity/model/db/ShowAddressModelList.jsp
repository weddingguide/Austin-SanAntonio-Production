<% AddressModelList theObjectList = (AddressModelList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% AddressModel theObject = (AddressModel) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
