...
public class PhoneModelDBRecordBase extends ServletRecord
{
   ...
   public PhoneModelDBRecordBase( DBData aDbData, ResultSet results )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( results );
//    log.logEvent( log.TRACE, "PhoneModelDBRecordBase constructor from ResultSet");
   }
   ...
   public PhoneModelDBRecordBase( DBData aDbData, HttpServletRequest request, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( request, label );
//    log.logEvent( log.TRACE, "PhoneModelDBRecordBase constructor from label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PhoneModelDBRecordBase( DBData aDbData, Hashtable hashTable, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( hashTable, label );
//    log.logEvent( log.TRACE, "PhoneModelDBRecordBase constructor from hashTable - label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PhoneModelDBRecordBase( DBData aDbData, HttpServletRequest request, String label, int aId )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      id = aId;
      populateObject( request, label );
//    log.logEvent( log.TRACE, "PhoneModelDBRecordBase constructor from label: " + label + " & id: " + id );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PhoneModelDBRecordBase( DBData dbData )
   {
      super( dbData );
      createColumnObjects( dbData );
//    log.logEvent( log.TRACE, "PhoneModelDBRecordBase basic constructor");
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PhoneModelDBRecordBase( DBData dbData, String[] fields, int[] map )
   {
      super( dbData );
      createColumnObjects( dbData );
      log.logEvent( log.TRACE, "PhoneModelDBRecordBase constructor from array");
   ...
   protected void createColumnObjects( DBData aDbData )
   {
      ...
      dbColumns[0] = new ServletStringColumn( aDbData, "PHONEMODEL.NAME", "PHONEMODEL", "name" );
   ...
   {
      String retString = "\n" + prefix + "PhoneModel Object:";
      try 
      {
         refreshColumnObjects();
         retString += "\n"+ prefix +   "    name (PHONEMODEL.NAME) -- ";
   ...
   public String toCSVHeaderString(PhoneModelViewBase viewDef, int ndx )
   {
      String retString = "";
   ...
   public String toCSVString(PhoneModelViewBase viewDef )
   {
      String retString = "";
      try 
      {
   ...
   {
      sysLogger.info( "DROP TABLE PHONEMODEL;" );
      sysLogger.info( "CREATE TABLE PHONEMODEL ( PHONEMODEL.NAME char );" );
   }
   public String exportSQLInsertStatement()
   {
      refreshColumnObjects();
      String retString = "PhoneModel Object:";
