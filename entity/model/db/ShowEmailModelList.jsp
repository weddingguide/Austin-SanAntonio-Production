<% EmailModelList theObjectList = (EmailModelList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% EmailModel theObject = (EmailModel) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
