...
public class PersonModelDBRecordBase extends ServletRecord
{
   ...
   public PersonModelDBRecordBase( DBData aDbData, ResultSet results )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( results );
//    log.logEvent( log.TRACE, "PersonModelDBRecordBase constructor from ResultSet");
   }
   ...
   public PersonModelDBRecordBase( DBData aDbData, HttpServletRequest request, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( request, label );
//    log.logEvent( log.TRACE, "PersonModelDBRecordBase constructor from label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PersonModelDBRecordBase( DBData aDbData, Hashtable hashTable, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( hashTable, label );
//    log.logEvent( log.TRACE, "PersonModelDBRecordBase constructor from hashTable - label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PersonModelDBRecordBase( DBData aDbData, HttpServletRequest request, String label, int aId )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      id = aId;
      populateObject( request, label );
//    log.logEvent( log.TRACE, "PersonModelDBRecordBase constructor from label: " + label + " & id: " + id );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PersonModelDBRecordBase( DBData dbData )
   {
      super( dbData );
      createColumnObjects( dbData );
//    log.logEvent( log.TRACE, "PersonModelDBRecordBase basic constructor");
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public PersonModelDBRecordBase( DBData dbData, String[] fields, int[] map )
   {
      super( dbData );
      createColumnObjects( dbData );
      log.logEvent( log.TRACE, "PersonModelDBRecordBase constructor from array");
   ...
   protected void createColumnObjects( DBData aDbData )
   {
      ...
      dbColumns[0] = new ServletStringColumn( aDbData, "PERSONMODEL.NAME", "PERSONMODEL", "name" );
   ...
   {
      String retString = "\n" + prefix + "PersonModel Object:";
      try 
      {
         refreshColumnObjects();
         retString += "\n"+ prefix +   "    name (PERSONMODEL.NAME) -- ";
   ...
   public String toCSVHeaderString(PersonModelViewBase viewDef, int ndx )
   {
      String retString = "";
   ...
   public String toCSVString(PersonModelViewBase viewDef )
   {
      String retString = "";
      try 
      {
   ...
   {
      sysLogger.info( "DROP TABLE PERSONMODEL;" );
      sysLogger.info( "CREATE TABLE PERSONMODEL ( PERSONMODEL.NAME char );" );
   }
   public String exportSQLInsertStatement()
   {
      refreshColumnObjects();
      String retString = "PersonModel Object:";
