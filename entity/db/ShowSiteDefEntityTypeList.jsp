<% SiteDefEntityTypeList theObjectList = (SiteDefEntityTypeList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% SiteDefEntityType theObject = (SiteDefEntityType) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
    ...
    <td>
       <%= theObject.getEntityType() %>
    </td>
    <td>
       <%= theObject.getName() %>
    </td>
    <td>
       <%= theObject.getSearchDefault() %>
    </td>
    <td>
       <%= theObject.getMatchEntityStatus() %>
    </td>
    <td>
