<% SavedQueriesList theObjectList = (SavedQueriesList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% SavedQueries theObject = (SavedQueries) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
