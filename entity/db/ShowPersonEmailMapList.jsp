<% PersonEmailMapList theObjectList = (PersonEmailMapList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% PersonEmailMap theObject = (PersonEmailMap) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
