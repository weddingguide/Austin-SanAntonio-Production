<% GroupPersonMapList theObjectList = (GroupPersonMapList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% GroupPersonMap theObject = (GroupPersonMap) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
