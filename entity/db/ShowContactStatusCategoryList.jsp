<% ContactStatusCategoryList theObjectList = (ContactStatusCategoryList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% ContactStatusCategory theObject = (ContactStatusCategory) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
