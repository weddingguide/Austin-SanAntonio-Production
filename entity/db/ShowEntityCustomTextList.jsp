<% EntityCustomTextList theObjectList = (EntityCustomTextList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% EntityCustomText theObject = (EntityCustomText) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
    ...
    <td>
       <%= theObject.getObjectType() %>
    </td>
    <td>
       <%= theObject.getInstance() %>
    </td>
    <td>
       <%= theObject.getLongName() %>
    </td>
    <td>
       <%= theObject.getShortName() %>
    </td>
    <td>
