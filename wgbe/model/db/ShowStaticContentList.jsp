<% StaticContentList theObjectList = (StaticContentList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% StaticContent theObject = (StaticContent) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
