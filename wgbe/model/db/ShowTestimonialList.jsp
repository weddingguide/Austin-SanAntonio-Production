<% TestimonialList theObjectList = (TestimonialList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% Testimonial theObject = (Testimonial) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
