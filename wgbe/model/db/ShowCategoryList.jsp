<% CategoryList theObjectList = (CategoryList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% Category theObject = (Category) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
    ...
    <td>
       <%= theObject.getImageTag() %>
    </td>
    <td>
       <%= theObject.getUrl() %>
    </td>
    <td>
       <%= theObject.getSelectedText() %>
    </td>
    <td>
