<% VirtualTourList theObjectList = (VirtualTourList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% VirtualTour theObject = (VirtualTour) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
