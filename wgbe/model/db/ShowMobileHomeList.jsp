<% MobileHomeList theObjectList = (MobileHomeList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% MobileHome theObject = (MobileHome) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
