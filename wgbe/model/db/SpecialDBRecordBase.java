...
public class SpecialDBRecordBase extends ServletRecord
{
   ...
   public SpecialDBRecordBase( DBData aDbData, ResultSet results )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( results );
//    log.logEvent( log.TRACE, "SpecialDBRecordBase constructor from ResultSet");
   }
   ...
   public SpecialDBRecordBase( DBData aDbData, HttpServletRequest request, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( request, label );
//    log.logEvent( log.TRACE, "SpecialDBRecordBase constructor from label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public SpecialDBRecordBase( DBData aDbData, Hashtable hashTable, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( hashTable, label );
//    log.logEvent( log.TRACE, "SpecialDBRecordBase constructor from hashTable - label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public SpecialDBRecordBase( DBData aDbData, HttpServletRequest request, String label, int aId )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      id = aId;
      populateObject( request, label );
//    log.logEvent( log.TRACE, "SpecialDBRecordBase constructor from label: " + label + " & id: " + id );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public SpecialDBRecordBase( DBData dbData )
   {
      super( dbData );
      createColumnObjects( dbData );
//    log.logEvent( log.TRACE, "SpecialDBRecordBase basic constructor");
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public SpecialDBRecordBase( DBData dbData, String[] fields, int[] map )
   {
      super( dbData );
      createColumnObjects( dbData );
      log.logEvent( log.TRACE, "SpecialDBRecordBase constructor from array");
   ...
   protected void createColumnObjects( DBData aDbData )
   {
      ...
      dbColumns[0] = new ServletStringColumn( aDbData, "SPECIAL.NAME", "SPECIAL", "name" );
   ...
   {
      String retString = "\n" + prefix + "Special Object:";
      try 
      {
         refreshColumnObjects();
         retString += "\n"+ prefix +   "    name (SPECIAL.NAME) -- ";
   ...
   public String toCSVHeaderString(SpecialViewBase viewDef, int ndx )
   {
      String retString = "";
   ...
   public String toCSVString(SpecialViewBase viewDef )
   {
      String retString = "";
      try 
      {
   ...
   {
      sysLogger.info( "DROP TABLE SPECIAL;" );
      sysLogger.info( "CREATE TABLE SPECIAL ( SPECIAL.NAME char );" );
   }
   public String exportSQLInsertStatement()
   {
      refreshColumnObjects();
      String retString = "Special Object:";
      retString += "\n    name (SPECIAL.NAME) -- ";
      retString += "localVar=\"" + name.toString() + "\";  ";
      retString += dbColumns[0].toString();
      return( retString);
