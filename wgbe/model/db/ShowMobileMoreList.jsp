<% MobileMoreList theObjectList = (MobileMoreList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% MobileMore theObject = (MobileMore) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
