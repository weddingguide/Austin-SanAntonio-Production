<% SpecialsList theObjectList = (SpecialsList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% Specials theObject = (Specials) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
