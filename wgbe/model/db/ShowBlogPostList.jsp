<% BlogPostList theObjectList = (BlogPostList) requestData.getRequest().getSession().getValue( "theObjectList" ); %>
<script>
...
<table border=2>
 ...
 <% BlogPost theObject = (BlogPost) theObjectList.getRecordList()[i]; %> 
  <tr>
    <td>
