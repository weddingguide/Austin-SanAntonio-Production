...
public class VirtualTourDBRecordBase extends ServletRecord
{
   ...
   public VirtualTourDBRecordBase( DBData aDbData, ResultSet results )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( results );
//    log.logEvent( log.TRACE, "VirtualTourDBRecordBase constructor from ResultSet");
   }
   ...
   public VirtualTourDBRecordBase( DBData aDbData, HttpServletRequest request, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( request, label );
//    log.logEvent( log.TRACE, "VirtualTourDBRecordBase constructor from label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public VirtualTourDBRecordBase( DBData aDbData, Hashtable hashTable, String label )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      populateObject( hashTable, label );
//    log.logEvent( log.TRACE, "VirtualTourDBRecordBase constructor from hashTable - label: " + label );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public VirtualTourDBRecordBase( DBData aDbData, HttpServletRequest request, String label, int aId )
   {
      super( aDbData );
      createColumnObjects( aDbData );
      id = aId;
      populateObject( request, label );
//    log.logEvent( log.TRACE, "VirtualTourDBRecordBase constructor from label: " + label + " & id: " + id );
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public VirtualTourDBRecordBase( DBData dbData )
   {
      super( dbData );
      createColumnObjects( dbData );
//    log.logEvent( log.TRACE, "VirtualTourDBRecordBase basic constructor");
   }
 
   //====generated===========generated=========generated==========generated=====
   //====generated===========generated=========generated==========generated=====
 
   public VirtualTourDBRecordBase( DBData dbData, String[] fields, int[] map )
   {
      super( dbData );
      createColumnObjects( dbData );
      log.logEvent( log.TRACE, "VirtualTourDBRecordBase constructor from array");
   ...
   protected void createColumnObjects( DBData aDbData )
   {
      ...
      dbColumns[0] = new ServletStringColumn( aDbData, "VIRTUALTOUR.NAME", "VIRTUALTOUR", "name" );
   ...
   {
      String retString = "\n" + prefix + "VirtualTour Object:";
      try 
      {
         refreshColumnObjects();
         retString += "\n"+ prefix +   "    name (VIRTUALTOUR.NAME) -- ";
   ...
   public String toCSVHeaderString(VirtualTourViewBase viewDef, int ndx )
   {
      String retString = "";
   ...
   public String toCSVString(VirtualTourViewBase viewDef )
   {
      String retString = "";
      try 
      {
   ...
   {
      sysLogger.info( "DROP TABLE VIRTUALTOUR;" );
      sysLogger.info( "CREATE TABLE VIRTUALTOUR ( VIRTUALTOUR.NAME char );" );
   }
   public String exportSQLInsertStatement()
   {
      refreshColumnObjects();
      String retString = "VirtualTour Object:";
